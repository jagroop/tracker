  ...
  <div>
    ...
    width="30%">
      <el-form ref="edit_form" :model="edit_form" label-width="120px">
        ...
        <el-form-item>
          <el-button type="primary" :loading="edit_form.busy" @click="updateTask">Create</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  ...
  export default {
    ...
    methods: {
      ...
      loadTasks(page) {
       ...
       // if(getFilters) {
       //  getFilters = JSON.parse(getFilters);
       //  self.filters.user_id = getFilters.user_id;
       //  self.filters.date = getFilters.date;
       // }
